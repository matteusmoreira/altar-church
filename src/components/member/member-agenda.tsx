...
export function MemberAgenda({ events }: { events: MemberAgendaEvent[] }) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Agenda" description="Cultos, eventos e programações da igreja." />
      {events.length === 0 && <EmptyState variant="card" icon={CalendarDays} title="Nenhum evento publicado nos próximos dias." />}
