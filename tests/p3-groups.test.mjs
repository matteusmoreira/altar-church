...
test("legacy GCEU route redirects to canonical cells module", () => {
  ...
  assert.match(page, /permanentRedirect\("\/celulas"\)/)
  ...
  assert.match(data, /requirePermission\("cells\.view"/)
  ...
  assert.match(actions, /requirePermission\("cells\.create"/)
  assert.match(actions, /requirePermission\("cells\.edit"/)
  assert.match(actions, /requirePermission\("cells\.delete"/)
