...
test("P1 operational dashboard routes use server-side module and permission layouts", () => {
  const guardedRoutes = {
    ...
    cells: ["cells", "cells.view"],
    "church-info": ["church-info", "settings.edit"],
    communication: ["communication", "communication.view"],
    congregations: ["congregations", "members.view"],
    content: ["content", "content.view"],
    crm: ["crm", "crm.view"],
    dashboard: ["dashboard", null],
    donations: ["donations", "donation.view"],
    ...
    ministries: ["ministries", "ministries.view"],
    notifications: ["notifications", "notification.view"],
    prayer: ["prayer", "prayer.view"],
    programming: ["programming", null],
    "reading-plans": ["reading-plans", null],
    reports: ["reports", "reports.view"],
    settings: ["settings", "settings.manage_settings"],
    songs: ["songs", null],
    visitors: ["visitors", "visitors.view"],
  }
