...
test("attendance and crm link people from directory", () => {
  ...
  assert.match(attendance, /items=\{personOptions\}/)
  assert.match(attendance, /items=\{eventTypeOptions\}/)
  assert.match(attendance, /items=\{statusOptions\}/)
  assert.match(attendance, /Informar outro nome/)
  assert.match(attendance, /Tipo de encontro/)
  assert.match(attendance, /Situação/)
